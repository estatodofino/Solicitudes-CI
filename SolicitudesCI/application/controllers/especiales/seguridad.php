...
class Seguridad extends CI_Controller {
    ...
    public function cambiclave()
    {
      $this->load->view('overall/header');
      $this->load->view('overall/menuSoles');
      $this->load->view('especiales/seguridad/claves');
      $this->load->view('overall/footer');
    }
    public function Actualizar()
    {
      ...
      $this->load->view('overall/header');
      $this->load->view('overall/menuSoles');
      $this->load->view('especiales/seguridad/Actualizar',$data);
      $this->load->view('overall/footer');
    }
    public function update()
    {
      ...
      $usuarioActual = $this->Usuarios_model->get_user($id_usuario);
  ...
  if ($this->Usuarios_model->update($idusuario,$data)) {
   $this->session->set_flashdata("success","se ha modificado satisfactoriamente");
      ...
      redirect(base_url()."especiales/seguridad/actualizar/".$idusuario);
    }
  }else {
    $this->actualizar();
  }
