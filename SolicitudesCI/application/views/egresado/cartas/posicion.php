...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
        <b>Nueva solicitud</b>
        <small>Carta de Posición y Rango</small>
        </h1>
    </section>
    <!-- Main content -->
<section class="content">
 ...
 <div class="box box-solid">
    <div class="box-body">
      <form action="<?php echo base_url();?>egresado/solicitudes/store" method="POST" enctype="multipart/form-data">
        <div class="form-group col-md-12 <?php echo !empty(form_error('numero')) ? 'has-error':'';?>">
            <label for="numero">N° de Solicitud:</label>
        ...
        <input type="hidden" class="form-control" name="tipo_sol" value="posicion">
...
<!--<div class="form-group <?php echo form_error("egreso") != false ? 'has-error':'';?>">
    ...
    <?php echo form_error("egreso","<span class='help-block'>","</span>");?>
      ...
      <div class="form-group col-md-12">
          <button type="submit" id="solicitud" class="btn btn-success btn-flat">
          <span class="fa fa-send"></span> Solicitar</button>
          <a type="button" value="egresado/solicitudes" name="button" class="btn btn-cancel btn-danger"><span class="fa fa-remove"></span> Cancelar</a>
      </div>
      </form>
    ...
    <div class="modal-content">
       ...
       <div class="modal-body">
         <?=form_open_multipart(base_url()."egresado/solicitudes/subirDoc")?>
          ...
          <input type="hidden" name="direccion" value="egresado/solicitudes/posicion"/>
          <input type="hidden" name="direccion2" value="egresado/cartas/posicion"/>
