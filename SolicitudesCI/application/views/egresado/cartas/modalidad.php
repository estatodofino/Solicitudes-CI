...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
        Nueva solicitud
        <small>Carta de Modalidad</small>
        </h1>
    </section>
    <!-- Main content -->
 ...
 <div class="box box-solid">
  <div class="box-body">
      <form action="<?php echo base_url();?>egresado/solicitudes/store" method="POST" enctype="multipart/form-data">
        ...
        <input type="hidden" class="form-control" name="tipo_sol" value="modalidad">
...
<!--  <div class="form-group <?php echo form_error("egreso") != false ? 'has-error':'';?>">
    ...
    <?php echo form_error("egreso","<span class='help-block'>","</span>");?>
      ...
      <div class="form-group col-md-12">
          <button type="submit" class="btn btn-success btn-flat"><span class="fa fa-send"></span> Solicitar</button>
    ...
    <div class="modal-content">
       ...
       <div class="modal-body">
         <?=form_open_multipart(base_url()."egresado/solicitudes/subirDoc")?>
          ...
          <input type="hidden" name="direccion" value="egresado/solicitudes/modalidad"/>
          <input type="hidden" name="direccion2" value="egresado/cartas/modalidad"/>
