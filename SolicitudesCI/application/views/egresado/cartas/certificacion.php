...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
        Nueva Solicitud
        <small>Certificacion de Programas</small>
        </h1>
    </section>
    <!-- Main content -->
<section class="content">
 ...
 <div class="box box-solid">
    <div class="box-body"> 
      <form action="<?php echo base_url();?>egresado/solicitudes/Certificacion_programas" method="POST">
    ...
    <div class="modal-content">
       ...
       <div class="modal-body">
         <?=form_open_multipart(base_url()."egresado/solicitudes/subirDoc")?>
          ...
          <input type="hidden" name="direccion" value="egresado/solicitudes/Certificacion"/>
          <input type="hidden" name="direccion2" value="egresado/cartas/Certificacion"/>
             <div class="form-group">
                <label for="titulo" >Titulo</label>
                 <select name="titulo" >
                    <option value="Macur" >Relacion de Materias Cursadas</option>
