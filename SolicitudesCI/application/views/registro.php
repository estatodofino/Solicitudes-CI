           ...
           $("#fomularios").html(
            '<div id="fomularios">'+
              '<form action="'+base_url+'welcome/registrar" method="POST">'+          
                ...
                '<div class="form-group"> <label for="nombres">Primer Nombre:</label>'+
                    '<input type="text" class="form-control" id="nombres" name="nombres"></div>'+

                  '<div class="form-group"><label for="apellidos">Primer Apellido:</label><input type="text" class="form-control" id="apellidos" name="apellidos"></div>'+
                  ...
                  '<div class="form-group"><label for="correo">Correo electronico:</label><input type="email" class="form-control" id="correo" name="correo"> </div>'+
