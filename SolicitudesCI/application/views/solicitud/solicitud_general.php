...
<?php if ($this->session->userdata("rol")=="1") {
  if ($ordenes->tipo_solicitud =="11") {
    $url_l = "administrar/solicitudes/culminacion";
  }elseif ($ordenes->tipo_solicitud =="12") {
    $url_l = "administrar/solicitudes/posicion";
  }elseif ($ordenes->tipo_solicitud =="13") {
    $url_l = "administrar/solicitudes/modalidad";
  }elseif ($ordenes->tipo_solicitud =="14") {
    $url_l = "administrar/solicitudes/certificacion_Programas";
  }elseif ($ordenes->tipo_solicitud =="15") {
    $url_l = "administrar/solicitudes/certificacion_Pensum";
  }
}elseif ($this->session->userdata("rol")=="2") {
  $url_l = "activos/solicitudes";
}elseif ($this->session->userdata("rol")=="3") {
  $url_l = "egresado/solicitudes";
} ?>

      <input type="hidden" id="url_l" value="<?=$url_l;?>">

      <input type="hidden" id="table" value="solicitud_general">
             ...
             <div class="row no-print">
                <div class="col-xs-12">
                 ...
                 <a class="btn btn-homero btn-danger"><span class="fa fa-remove"></span> Cancelar Solicitud</a>
                  <a href="<?php base_url();?>" class="btn btn-default btn-print pull-right"><i class="fa fa-print"></i> Print</a>
                </div>
              </div>
                  <div id="informes"></div>
                </div>
