 ...
 <div class="box box-solid">
     <div class="box-body">
      <div class="row">
          ...
          <br>
          <br>
          <?php if($ordenes->tipo_solicitud=="9"){?>

          <div class="row invoice-info">
            <div class="col-sm-4 invoice-col">
              <b>Carrera de Actual</b>
              <address>
                <strong>Nombre: </strong><?=$ordenes->carrera_origen;?><br>
                <strong>Nucleo: </strong><?=$ordenes->cod_ubicacion;?><br>
            ...
            <div class="col-sm-4 invoice-col">
              ...
              <address>
                <strong>Nombre: </strong>Computacion<br>
                <strong>Nucleo: </strong>Punto fijo<br>
                <strong>Periodo de la solicitud: </strong><?=$ordenes->periodo;?><br>
              </address>
            </div>
            <!-- /.col -->
          </div>
         <?php } elseif($ordenes->tipo_solicitud=="8"){?>
         ...
         <?php } if ($this->session->userdata("rol")=="1") {
            if ($ordenes->tipo_solicitud =="8") {
                $url_l = "administrar/solicitudes/reincorporacion";
                }elseif ($ordenes->tipo_solicitud =="9") {
                  $url_l = "administrar/solicitudes/cambio";
                }
...
<input type="hidden" id="table" value="solicitud_especiales">
