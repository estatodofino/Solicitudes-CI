...
<div class="content-wrapper">
    ...
    <section class="content">
     ...
     <div class="col-md-12">
        ...
        <?php endif;?>
    <form action="<?php echo base_url();?>administrar/Seguridad/update_rol" method="POST">
        ...
        <div class="form-group">
            ...
            <select name="rol" id="rol" class="form-control">
                <?php foreach($roles as $rol):?>
                    <option value="<?php echo $rol->cod_tipo_usuario;?>" <?php echo $rol->cod_tipo_usuario == $usuario->cod_tipo_usuario ? "selected":"";?>><?php echo $rol->tipo_usuario;?></option>
                <?php endforeach;?>
            </select>
        </div>
        <div class="form-group">
