...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
        Nueva Solicitud
        <small>Solicitud de reincorporacion.</small>
        </h1>
    </section>
    <!-- Main content -->
  ...
  <?php if($errorArch !=""):?>
     ...
     <div class="box box-solid">
      <div class="box-body">
       <form action="<?php echo base_url();?>especiales/solicitudes/reincorporacion_store" method="POST">
        <input type="hidden" class="form-control" name="tipo_sol" value="reincorporacion">
     ...
     <br>
      ...
      <div class="form-group col-md-12 callout callout-defaul">
       <div class="row">
        ...
        <!-- <div class="form-group col-md-4 <?php echo !empty(form_error('year')) ? 'has-error':'';?>">
    ...
    <div class="modal-content">
       ...
       <div class="modal-body">
         <?=form_open_multipart(base_url()."especiales/solicitudes/subirDoc")?>
          ...
          <input type="hidden" name="direccion" value="especiales/solicitudes/reincorporacion"/>
          <input type="hidden" name="direccion2" value="especiales/cartas/reincorporacion"/>
                ...
                <label for="titulo" >Titulo</label>
                 <select name="titulo" class="form-control" >
                   <option value="Fotocopia de CI">Copia de CI</option>
                    ...
                    <option value="Titulo de bachiller" >Titulo de bachiller original (*)</option>
