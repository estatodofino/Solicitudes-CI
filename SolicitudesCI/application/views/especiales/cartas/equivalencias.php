...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1> 
        Nueva Solicitud
        <small>Solicitud de equivalencias (Usuario egresado)</small>
        </h1>
    </section>
    <!-- Main content -->
    ...
    <div class="box-body">
     <div class="form-group col-md-12 callout callout-defaul">
       <form action="<?php echo base_url();?>especiales/solicitudes/store_equivalencia" method="POST">
        <input type="hidden" class="form-control" name="tipo_sol" value="egresado">
     ...
     <br>
          <div class="row">
        <h4>Informacion academica (Educacion superior) </h4> 
        <br>
    ...
    <div class="modal-content">
       ...
       <div class="modal-body">
         <?=form_open_multipart(base_url()."egresado/solicitudes/subirDoc")?>
          ...
          <input type="hidden" name="direccion" value="especiales/solicitudes/equivalencias_egresado"/>
          <input type="hidden" name="direccion2" value="especiales/cartas/equivalencias"/>
             <div class="form-group">
                <label for="titulo" >Titulo</label>
                 <select name="titulo" class="form-control" >                  
                   ...
                   <option value="Titulo obtenido">Titulo Universitario(Fondo Blanco)</option>
