...
$this->load->view('registro',$data);
		...
		public function registrar()
		{
			...
			if(!empty($nombres) and !empty($apellidos) and !empty($cedula) and !empty($correo) and !empty($year) and !empty($periodo) and !empty($password) and !empty($password2) ) {
			if ($res==False) {
			...
			$this->periodo_user($periodo,$year,$cedula);
