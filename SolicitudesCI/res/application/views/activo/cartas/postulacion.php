 ...
 <div class="box box-solid">
    <div class="box-body">
      ...
      <div class="form-group col-md-6 <?php echo !empty(form_error('tutor_e_ci')) ? 'has-error':'';?>">
          <label for="tutor_e_ci">Cedula:</label><input type="text" class="form-control" id="tutor_e_ci" name="tutor_e_ci" disabled="disabled">
      ...
      <div class="form-group col-md-6 <?php echo !empty(form_error('profesion')) ? 'has-error':'';?>">
          <label for="profesion">Profesion:</label><input type="text" class="form-control" id="profesion" name="profesion" value="<?php echo set_value('profesion');?>" disabled="disabled">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
                        ...
                        <?php if(!empty($empresas)):?>
                            <?php foreach($empresas as $empresa):?>
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-success btn-check" value="<?php echo $dataempresa;?>"><span class="fa fa-check"></span></button>
                                    </td>
                                </tr>
                            <?php endforeach;?>
                        <?php endif;?>
            ...
            <div class="modal-footer">
                ...
                <a class="btn btn-primary" href="<?php echo base_url();?>cliente/nuevo/"><span class="fa fa-plus"> Nuevo</span></a>
            </div>
        </div>
        <!-- /.modal-content -->
    </div>
