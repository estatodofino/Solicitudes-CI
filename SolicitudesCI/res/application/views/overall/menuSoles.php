                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                      <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                          <li>
                            <a href="<?php echo base_url();?>especiales/solicitudes/traslado_aviso"><i class="fa fa-circle-o"></i> Traslado y <br>reincorporacion
                            </a>
                          </li>
                          <li>
                            <a href="<?php echo base_url();?>especiales/solicitudes/equivalencias_aviso"><i class="fa fa-circle-o"></i> Equivalencias
                            </a>
                          </li>
                          <li>
